...
option_list <- list(
	...
	make_option(c("--cytobandFile"), type = "character", default = NULL,
            help = "Cytoband file required by hg38, can be downloaded from UCSC. [Default: %default]"),
